...
public class AlbumSongAdapter extends SongAdapter {
    ...
    public AlbumSongAdapter(AppCompatActivity activity, ArrayList<Song> dataSet, OnItemClickListener<Song> onItemClickListener, @LayoutRes int itemLayoutRes, boolean usePalette, @Nullable CabHolder cabHolder) {
